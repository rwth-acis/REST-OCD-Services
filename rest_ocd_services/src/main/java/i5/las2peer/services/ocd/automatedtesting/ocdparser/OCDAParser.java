...
public class OCDAParser {
     ...
     * @return                  String representation of the path to the OCDA test class
     */
    ...
    /**
     * @param ocdaName          Name of the OCDA test class that was auto-generated
     * @return                  String representation of the path to the OCDA test class
     */
    public static String getAutoGeneratedTestPath(String ocdaName) {

        String relativeFilePath = "rest_ocd_services/src/test/java/i5/las2peer/services/ocd/" +
                "ocdatestautomation/testrunner/generatedclasses/" + ocdaName;
