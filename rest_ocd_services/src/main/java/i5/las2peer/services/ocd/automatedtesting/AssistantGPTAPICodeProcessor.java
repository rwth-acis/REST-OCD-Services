...
//
    ...
    public static String processOCDAMethodGPTTestCodeAndGenerateSubsequentPrompt(String ocdaName, List<String> methodNames) {
        ...
        //TODO: maybe add case distinction between whether the file with tests already exists, similar to processGraphTypeRelatedGPTTestCodeAndGenerateSubsequentPrompt
    ...
    public static String processAutoGeneratedCode(String ocdaName, Boolean isForGraphTypeTest){
        ...
        //TODO add this functionality to PromptGenerator and the prompt should also be written
        ...
        generateAndWriteFile("gpt/prompts/" + ocdaName
    ...
    public static ArrayList<String> evaluateGPTGeneratedCode(String ocdaName, Boolean isForGraphTypeTests){
        ...
        autoGeneratedTestClassPath = FileHelpers.getAutoGeneratedUnprocessedUnitTestPath(ocdaName + OCDATestAutomationConstants.GPT_GENERATED_TEST_FILE_NAME_SUFFIX);
        ...
        File gptInputReference = new File(FileHelpers.getAutoGeneratedUnparsedTestPath(ocdaName +"Test.java"));
