...
public class PromptGenerator {
    ...
    public static String generateAndWriteGraphTypeRelatedTestPrompt(File ocdaCode) {
        ...
        createGPTResponseFile(OCDAParser.getClassName(ocdaCode), "");
    ...
    /**
     * Create a file where GPT response should be stored for further processing.
     * @param ocdaName     Name of the OCD algorithm for which the file should be
     *                     created (i.e. OCDA for which the tests are generated).
     */
    public static void createGPTResponseFile(String ocdaName, String content){
        String gptResponseFilePath = FileHelpers.getAutoGeneratedUnprocessedUnitTestPath(ocdaName + "_gpt_generated_tests.txt");
