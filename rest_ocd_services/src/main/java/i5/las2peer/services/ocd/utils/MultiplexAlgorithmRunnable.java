 ...
 *
 */
public class MultiplexAlgorithmRunnable implements Runnable {
	 ...
	 */
	private OcdMultiplexAlgorithm algorithm;
	/**
	 ...
	 */
	public MultiplexAlgorithmRunnable(Cover cover, OcdMultiplexAlgorithm algorithm, int componentNodeCountFilter, ThreadHandler threadHandler) {
	...
	public void run() {
		...
		if(!error) {
	        ...
	        try {
	        	//resultCover = executor.executeMultiplex(cover.getGraph(), algorithm, componentNodeCountFilter);
