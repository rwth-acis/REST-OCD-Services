...
import static i5.las2peer.services.ocd.automatedtesting.ocdparser.OCDAParser.getAutoGeneratedTestPath;
import static i5.las2peer.services.ocd.automatedtesting.ocdparser.OCDAParser.getOCDATestPath;
...
public class CodeValiditySubmetric {
     ...
     */
    private static boolean noParsingErrorFound = true;

    /**
     * True if the parsed code is executable
     */
    private static boolean noRuntimeErrorFound = true;
    ...
    public static boolean evaluateIsCodeRunnable(File gptOutput) {
        try {
            ...
            String fullTestClassPath = AUTO_GENERATED_TEST_CLASS_PACKAGE + "." + testClassName;
    ...
    public static void main(String[] args) {
        ...
        evaluateIsCodeRunnable(parsedGptOutput); // input should be GPT output that was successfully parsable to see if it is executable
