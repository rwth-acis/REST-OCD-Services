...
//	SIGNED_DMID_EXTENDED_ALGORITHM(SignedDMIDExtendedAlgorithm.class,17);
	...
	/**
	 * Type corresponding to the GraphNeuralNetworkAlgorithm Algorithm.
	 */
	GRAPH_NEURAL_NETWORK_ALGORITHM("Graph Neural Network Algorithm", GraphNeuralNetwork.class ,26 );
