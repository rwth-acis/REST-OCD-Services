...
//	SIGNED_DMID_EXTENDED_ALGORITHM(SignedDMIDExtendedAlgorithm.class,17);
	...
	/**
	 * Type corresponding to the NeighboringLocalClusteringAlgorithm Algorithm.
	 */
	NEIGHBORING_LOCAL_CLUSTERING_ALGORITHM("Neighboring Local Clustering Algorithm", NeighboringLocalClusteringAlgorithm.class, 28);
	/**
