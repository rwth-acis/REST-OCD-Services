...
public class CodeModificationSubmetric {
    ...
    public static double evaluateMethodCommentModification(File gptOutput, File gptInput) {
        ...
        for (Map.Entry<String, String> entry : inputComments.entrySet()) {
            ...
            if (inputComment.contains(AUTO_GENERATED_COMMENT_STRING) || inputComment.contains("Auto-Generated by ChatGPT")) {
                ...
                if (!outputComment.contains(AUTO_GENERATED_COMMENT_STRING) && !outputComment.contains("Auto-Generated by ChatGPT")) {
