...
/*
 * GML format parser. Node names will be set from node labels if each node
 * has a unique name. Edge weights will be set from edge labels if they
 * correspond numeric values.
 */
