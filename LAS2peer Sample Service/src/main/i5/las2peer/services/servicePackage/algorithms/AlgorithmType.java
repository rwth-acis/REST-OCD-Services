...
public enum AlgorithmType {
	...
	UNDEFINED (0),
	GROUND_TRUTH (1),
	EXTENDED_RANDOM_WALK_LABEL_PROPAGATION_ALGORITHM (2),
	...
	public OcdAlgorithm getAlgorithmInstance() {
		switch (this) {
			...
			case GROUND_TRUTH:
				return null;
			case EXTENDED_RANDOM_WALK_LABEL_PROPAGATION_ALGORITHM:
				return new ExtendedRandomWalkLabelPropagationAlgorithm();
