...
public class GraphProcessor {
	...
	public Cover mergeComponentCovers(CustomGraph graph, List<Pair<Cover, Map<Node, Node>>> componentCovers) {
		...
		AlgorithmLog algo = new AlgorithmLog(AlgorithmType.UNDEFINED, new HashMap<String, String>(), null);
	 ...
	 * the graph type "weighted" will not be removed from the types attribute due to efficiency reasons.
	 * However the graph types attribute of the adapted graph is guaranteed to only inlcude types
